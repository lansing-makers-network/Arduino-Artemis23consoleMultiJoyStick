...
mprs chips[] = {
                    ...
                    (mprs) {MPR121C, 0x5C,
                     //  00    01    02    03    04    05    06    07    08    09    10    11                             
                      ...
                      {  10,   10,   10,   10,   10,   10,   10,   10,   10,   10,   10,   10}, //rthresh     
                      {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, //modifier     
                      {0x00, 0x00, 0x63, 0x63, 0xB0, 0x65, 0x35, 0x36, 0x37, 0x38, 0x39, 0x30}, //key     
                      {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} //pressDuration     
                    }
                  };
#endif // ENGINEERING
...
mprs chips[] = {
                    ...
                    (mprs) {MPR121B, 0x5B, 
                     //  00    01    02    03    04    05    06    07    08    09    10    11                             
                      {  20,   20,   20,   20,   20,   20,   20,   20,   20,   20,   20,   20}, //tthresh      
                      {  10,   10,   10,   10,   10,   10,   10,   10,   10,   10,   10,   10}, //rthresh     
                      {0x00, 0x00, 0x00, 0x00, 0x81, 0x81, 0x81, 0x00, 0x00, 0x00, 0x00, 0x00}, //modifier     
...
mprs chips[] = {
                    (mprs) {MPR121A, 0x5A, 
                     //  00    01    02    03    04    05    06    07    08    09    10    11                             
                      ...
                      {  10,   10,   10,   10,   10,   10,   10,   10,   10,   10,   10,   10}, //rthresh     
                      {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, //modifier     
                      {0x69, 0x79, 0xB0, 0x75, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, //key     
                      {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00} //pressDuration     
                    }
                  };
#endif // SCIENCE
